...
<button type="submit" name="PERSONALSAVING" onclick="return confirm('You are about create a personal savings plan press OKAY to continue')" class="btn btn-primary">Submit</button>
